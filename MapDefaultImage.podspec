#
# Be sure to run `pod lib lint MapDefaultImage.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/malhal/MapDefaultImage"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Malcolm Hall" => "malhal@users.noreply.github.com" }
  s.source           = { :git => "https://github.com/malhal/MapDefaultImage.git", :tag => s.version.to_s }
  ...
  #s.resource_bundles = {
  #  'MapDefaultImage' => ['Pod/Assets/*.png']
  #}
  s.resources = 'MapDefaultImage/*'
